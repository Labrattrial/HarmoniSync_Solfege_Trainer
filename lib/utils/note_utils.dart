class NoteUtils {
  // Define the frequencies of the standard notes
  static const Map<String, double> noteFrequencies = {
    ...
    "D#5": 622.25, "E5": 659.26, "F5": 698.46, "F#5": 739.99, "G5": 783.99, "G#5": 830.61, "A5": 880.00,
    ...
    "G7": 3135.96, "G#7": 3322.44, "A7": 3520.00, "A#7": 3729.31, "B7": 3951.07, "C8": 4186.01,
  };

  // Convert frequency (Hz) to the closest note name
  static String frequencyToNote(double frequency) {
    // Find the closest note frequency
    String closestNote = '';
    double minDifference = double.infinity;

    noteFrequencies.forEach((note, noteFrequency) {
